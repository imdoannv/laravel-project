        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">2-Hour Return</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                                                        ...
                                                        <div class="fashion_section_2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-sm-4">
                                                                    <div class="box_main">
                                                                        <h4 style="height: 50px;margin-bottom: 10px"
                                                                            class="shirt_text">{{ $product->name }}</h4>
                                                                        <p class="price_text">Price <span
                                                                                style="color: #262626;">$ {{ $product->price }}</span>
                                                                        </p>
                                                                        <div class="tshirt_img"><img width="300px" height="500px"
                                                                                                     src="{{ asset($product->images->img1) }}">
                                                                        </div>
                                                                        <div class="btn_main">
                                                                            <div class="buy_bt">
                                                                                <form action="{{route('cart.store')}}" method="POST">
                                                                                    ...
                                                                                    <input type="hidden" name="quantity" id="quantity"
                                                                                           value="1">
                                                                                    <a href="{{route('cart.index',auth()->id())}}"
                                                                                       style="background: none;font-weight: bold; "> Add
                                                                                        to cart</a>

                                                                                </form>
                                                                            </div>
                                                                            <div class="seemore_bt"><a
                                                                                    href="{{route('home.show', $product->id)}}">View
                                                                                    Detail</a></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
