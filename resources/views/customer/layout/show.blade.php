...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('customer/images/logo.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico">

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
          integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="stylesheet" href="{{asset('customer/css/templatemo.css')}}">
    <link rel="stylesheet" href="{{asset('customer/css/custom.css')}}">

    <!-- Load fonts style after rendering the layout styles -->
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;200;300;400;500;700;900&display=swap">
    <!-- Sử dụng Font Awesome từ CDN -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">

    <!-- Slick -->
    <link rel="stylesheet" type="text/css" href="{{asset('customer/css/slick.min.css')}}">
    ...
    <div class="container text-light">
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:namdpph26892@fpt.edu.vn">doannvph27169@fpt.edu.vn</a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">036.37.38.586</a>
            </div>
            <div>
    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="{{asset($product->images->img1)}}" alt="Card image cap"
                         id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="{{asset($product->images->img1)}}"
                                                 alt="Product Image 1">
                                        </a>
                                    </div>
            ...
            <div class="col-lg-7 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h1 class="h2"><strong>{{$product->name}}</strong></h1>
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <p class="text-muted"><strong>{{$product->size->name}}</strong></p>
                            </li>
                        </ul>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" width="300px" height="300px"
                                 src="{{asset($item->images->img1)}}">
                            <div
            ...
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-left text-light">
                        Designed by <a rel="sponsored" href="https://templatemo.com" target="_blank">DP | Foody</a>
                    </p>
                </div>
            </div>
        </div>
...
<!-- Start Script -->
<!-- Sử dụng phiên bản từ CDN -->
<script src="https://code.jquery.com/jquery-1.11.0.min.js"></script>
<script src="https://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
<!-- Sử dụng Bootstrap từ CDN -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
<script src="{{asset('customer/js/templatemo.js')}}"></script>
<script src="{{asset('customer/js/slick.min.js')}}"></script>
<script src="{{asset('customer/js/add-to-cart.js')}}"></script>
<script>
